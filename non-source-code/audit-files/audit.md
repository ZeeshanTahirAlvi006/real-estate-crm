...
Analyze the provided code explicitly against our `project.md` definitions. Provide a concise, bulleted markdown audit list flagging any of the following points from `project.md`.
