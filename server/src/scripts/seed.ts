...
export const seedDatabase = async (): Promise<void> => {
  try {
    ...
    // 7. Seed Notifications (25 realistic records for infinite scroll & drawer testing)
    logger.info('Seeding Notifications...')
    const notificationSeedData = [
      {
        brokerageId: alMirajBrokerage._id,
        userId: brokerageOwner._id,
        type: 'new_lead' as const,
        title: 'New High-Value Lead Assigned',
        message: 'Ayesha Siddiqua registered interest in DHA Phase 6 Luxury Villa ($750,000).',
        isRead: false,
        linkTo: '/leads',
      ...
      },
      {
        ...
        message: 'Inquiry received from Kamran Akram regarding payment milestones.',
        isRead: false,
        linkTo: '/inbox',
      ...
      },
      {
        ...
        message: 'Bahria Town Commercial Plot moved to Contract Review stage.',
        isRead: false,
        linkTo: '/pipeline',
      ...
      },
      {
        ...
        message: 'Hamza Farooq concluded client walkthrough at Gulberg Greens.',
        isRead: false,
        linkTo: '/calendar',
      ...
      },
      {
        ...
        message: '14 new comparable listings synchronized with CMA module.',
        isRead: true,
        linkTo: '/cma',
      ...
      },
      {
        ...
        message: 'Total active deal volume increased by 8.4% this week.',
        isRead: true,
        linkTo: '/dashboard',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'new_lead' as const,
        title: 'Zameen Portal Lead Received',
        message: 'Dr. Usman Qazi submitted inquiry for 1 Kanal Lake View plot.',
        isRead: true,
        linkTo: '/leads',
      ...
      },
      {
        ...
        message: 'Earnest money of PKR 1,500,000 confirmed for Clifton Heights.',
        isRead: true,
        linkTo: '/pipeline',
      ...
      },
      {
        ...
        message: 'Fatima Noor received signed buyer disclosure document.',
        isRead: true,
        linkTo: '/inbox',
      ...
      },
      {
        ...
        message: 'Open house event confirmed for Sunday at F-7 Markaz Penthouse.',
        isRead: true,
        linkTo: '/calendar',
        createdAt: new Date(Date.now() - 24 * 3600 * 1000),
      },
      {
        ...
        message: 'AI Data Cleanse auto-merged 2 duplicate lead profiles.',
        isRead: true,
        linkTo: '/contacts',
      ...
      },
      {
        ...
        message: 'Overseas buyer Bilal Ahmed submitted pre-approval documentation.',
        isRead: true,
        linkTo: '/leads',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'stage_change' as const,
        title: 'Listing Agreement Executed',
        message: 'Exclusive listing agreement signed for Park View City Villa.',
        isRead: true,
        linkTo: '/pipeline',
        createdAt: new Date(Date.now() - 42 * 3600 * 1000),
      },
      {
        brokerageId: alMirajBrokerage._id,
        userId: brokerageOwner._id,
        ...
        message: 'Sale Deed Amendment counter-signed by all 3 parties.',
        isRead: true,
        linkTo: '/esign',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'new_message' as const,
        title: 'Inbound SMS Alert',
        message: 'Buyer confirmed arrival time for tomorrow morning inspection.',
        isRead: true,
        linkTo: '/inbox',
        createdAt: new Date(Date.now() - 54 * 3600 * 1000),
      },
      {
        brokerageId: alMirajBrokerage._id,
        userId: brokerageOwner._id,
        ...
        message: 'Zainab Malik closed 3 commercial leases this month.',
        isRead: true,
        linkTo: '/dashboard',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'data_health' as const,
        title: 'Smart Contact Scoring Updated',
        message: 'Lead score increased to 92 for Ayesha Siddiqua based on activity.',
        isRead: true,
        linkTo: '/contacts',
        createdAt: new Date(Date.now() - 66 * 3600 * 1000),
      },
      {
        brokerageId: alMirajBrokerage._id,
        userId: brokerageOwner._id,
        type: 'new_lead' as const,
        title: 'Website Webhook Lead',
        message: 'Direct website inquiry for DHA Phase 8 commercial office.',
        isRead: true,
        linkTo: '/leads',
      ...
      },
      {
        ...
        message: 'Title verification completed successfully for Sector B plot.',
        isRead: true,
        linkTo: '/pipeline',
      ...
      },
      {
        ...
        message: 'PropPulse OS Enterprise Plan renewed successfully.',
        isRead: true,
        linkTo: '/settings',
      ...
      },
      {
        ...
        message: 'AI ISA scheduled automated check-in with cold buyer leads.',
        isRead: true,
        linkTo: '/inbox',
      ...
      },
      {
        ...
        message: 'Agent Bilal Ahmed Qureshi assigned to Downtown Luxury Portfolio.',
        isRead: true,
        linkTo: '/settings',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'data_health' as const,
        title: 'Audit Log Archiving Complete',
        message: 'Monthly system logs archived to secure cold storage.',
        isRead: true,
        linkTo: '/settings',
      ...
      },
      {
        ...
        userId: brokerageOwner._id,
        type: 'stage_change' as const,
        title: 'Price Adjustment Recorded',
        message: 'Listing price adjusted by -3.5% for Lake View Penthouse.',
        isRead: true,
        linkTo: '/pipeline',
      ...
      },
      {
        ...
        message: 'Two-factor authentication verified for all brokerage admins.',
        isRead: true,
        linkTo: '/settings',
        createdAt: new Date(Date.now() - 140 * 3600 * 1000),
      },
    ]

    await Notification.insertMany(
      notificationSeedData.map((n) => ({
        ...n,
        isDeleted: false,
      }))
    )
