...
const mainNavItems: NavItemDef[] = [
  ...
  { to: '/inbox?channel=all', icon: 'forum', label: 'Unified Inbox', permission: 'viewInbox' },
  { to: '/inbox?channel=whatsapp', icon: 'chat', label: 'WhatsApp Inbox', permission: 'viewInbox' },
  { to: '/inbox?channel=email', icon: 'mail', label: 'Email Inbox', permission: 'viewInbox' },
