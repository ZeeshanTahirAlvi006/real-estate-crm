...
export function LoginPage() {
  const [email, setEmail] = useState('alex.morgan@proppulse.io')
      ...
      <CardContent className="p-8">
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-10" onClick={() => toast.info('Google SSO coming soon')}>
            ...
            <Button variant="outline" className="h-10" onClick={() => toast.info('Microsoft SSO coming soon')}>
